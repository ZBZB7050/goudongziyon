...
$.innerKeyWords =
  ...
  "茶壶",  "记事本",  "帽子",  "保护壳",  "保护套",
  "皮带",  "裤带",  "洁面",  "毛巾",  "吹风机",  "牙线棒",
  "灯泡",  "数据线",  "盆",  "试用",  "袋子",  "激活码",  "打卡",  "考勤",  "赠品", "电话卡", "白板", "流量", "碎纸", "指甲刀", "蓝光膜", "隐私膜", "除草",  "打草",  "照明路灯",  "电锯",  "补水保湿",  "床垫",  "大红瓶",  "小蓝瓶",  "面霜",  "乳液",  "精华液",  "卡罗拉",  "牙雅阁",  "凉鞋",  "修护水",  "线控器",
    ]
...
let args_xh = {
  ...
  /*
     ...
     * 默认为 1 到 10
     * */
    tabId: process.env.JD_TRY_TABID && process.env.JD_TRY_TABID.split('@').map(Number) || [1,  2,  3,  4],
  /*
  ...
  /*
     ...
     * */
    applyNumFilter: process.env.JD_TRY_APPLYNUMFILTER *  1 ||  10000000000,
  /*
